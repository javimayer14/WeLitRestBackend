...
insert into historias (activo ,genero ,id_usuario ,relato ,titulo, imagen, mg, capitulos ) values (1,'Fantasia','prueba','Al caer la tarde, dos desconocidos se encuentran en los oscuros corredores de una galeria de cuadros. Con un ligero escalofrio uno le dijo al otro','El hombre y el cuadro','https://firebasestorage.googleapis.com/v0/b/welit-3d309.appspot.com/o/storyImages%2Fcuadro_galeria.jpg?alt=media&token=c49a9954-af7e-413e-b4fc-1f24387f576f',42,5);
insert into historias (activo ,genero ,id_usuario ,relato ,titulo, imagen, mg, capitulos ) values (1,'Fantasia','prueba','Era multimillonaria y del mas alto nivel','Prueba', 'https://firebasestorage.googleapis.com/v0/b/welit-3d309.appspot.com/o/storyImages%2Fpiramides.jpg?alt=media&token=a34ef33f-203f-40ae-a039-55d342bcd31c', 30, 12);

insert into historias (activo ,genero ,id_usuario ,relato ,titulo, imagen, mg, capitulos ) values (0,'Fantasia','prueba','Era multimillonaria y del mas alto nivel','El rey Leon', 'https://firebasestorage.googleapis.com/v0/b/welit-3d309.appspot.com/o/storyImages%2Fpiramides.jpg?alt=media&token=a34ef33f-203f-40ae-a039-55d342bcd31c',40,20);
insert into historias (activo ,genero ,id_usuario ,relato ,titulo, imagen, mg, capitulos ) values (0,'Fantasia','prueba','Era multimillonaria y del mas alto nivel','Caperusita roja', 'https://firebasestorage.googleapis.com/v0/b/welit-3d309.appspot.com/o/storyImages%2Fpiramides.jpg?alt=media&token=a34ef33f-203f-40ae-a039-55d342bcd31c',20,15);
